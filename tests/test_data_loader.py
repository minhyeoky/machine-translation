...
class TestDataLoader(unittest.TestCase):
    ...
    def test_len(self):
        ...
        self.assertEqual(len(self.data_loader.data_test), self.n_data * self.test_size)
    ...
    def test_train_generator(self):
        ...
        dataset = tf.data.Dataset.from_generator(self.data_loader.train_data_generator,
